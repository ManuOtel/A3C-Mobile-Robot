...
This is the class used to crate the Convolutional Block Attention VAE (CBAM-VAE) neural network.
...
class Trim(nn.Module):
    """Trim a tensor to a specific shape."""
    def __init__(self, *args):
        super().__init__()
...
class ChannelAttention(nn.Module):
    ...
    Inspired by Convolutional Block Attention Module (https://arxiv.org/abs/1807.06521)
    """
...
class SpatialAttention(nn.Module):
    ...
    Inpired by Spatial Attention Module (https://arxiv.org/abs/1807.06521)
    """
...
class VAE(nn.Module):
    """Variational Autoencoder with Channel Attention Module (CA) and Spatial Attention Module (SA).
    
    Inspired by Attention-Based Autoencoder for Image Reconstruction (https://arxiv.org/abs/1909.13409)
    
    Changes have been made to the original architecture, for improved performance and specificity."""
